(* OASIS_START *)
(* DO NOT EDIT (digest: 39c7b1a94c3c5acb93986ff8d5250326) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_extra";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("async_rpc_kernel", None);
                      ...
                      bs_c_sources = ["rpc_transport_low_latency_stubs.c"];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\231\217\1523\238D\168\012%\227\213\213\176\177\165!";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
